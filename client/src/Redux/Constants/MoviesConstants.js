...
export const MOVIES_TOPRATED_REQUEST = "MOVIES_TOPRATED_REQUEST";
export const MOVIES_TOPRATED_SUCCESS = "MOVIES_TOPRATED_SUCCESS";
export const MOVIES_TOPRATED_FAIL = "MOVIES_TOPRATED_FAIL";
